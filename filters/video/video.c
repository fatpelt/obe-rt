...
//PRINT_OBE_IMAGE(&raw_frame->img, "VIDEO FILTER  PRE");
        ...
        ltn_histogram_sample_begin(filter->filter_processing);
...
//PRINT_OBE_IMAGE(&raw_frame->img, "DITHER POST      ");
        ...
        ltn_histogram_sample_end(filter->filter_processing);
#if PRINT_HISTOGRAMS
        ltn_histogram_interval_print(STDOUT_FILENO, filter->filter_processing, 4);
#endif
